...
`mkdir -p /opt/gopath/src/github.com/sigmod2024ladon/`

Clone this repository unter the directory you created:

`cd /opt/gopath/src/github.com/sigmod2024ladon/`

`git clone https://github.com/sigmod2024ladon/ladon.git`

Checkout the`research-iss` branch.

### Installing Dependencies
With `/opt/gopath/src/github.com/sigmod2024ladon/ladon` as working directory, go to the deployment directory:
...
The default path to the repository is set to: `/opt/gopath/src/github.com/sigmod2024ladon/ladon/`.
...
Detailed instructions can be found  [here](https://github.com/sigmod2024ladon/ladon/tree/research-iss/deployment).
