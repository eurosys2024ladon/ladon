...
valFields = {'exp', 'batchtimeout', 'msgbatchperiod', 'cl-watermarks', 'buckets', 'num-connections', 'requests', 'rate-per-client', 'batch-size-10pctile-trunc', 'batch-size-90pctile-trunc', 'batch-size-avg-trunc', 'client-slack-1pctile-raw', 'client-slack-1pctile-trunc', 'client-slack-avg-raw', 'client-slack-avg-trunc', 'client-slack-stdev-raw', 'client-slack-stdev-trunc', 'commit-rate-raw', 'commit-rate-trunc', 'bandwidth-totoal', 'cpu-total', 'duration-raw', 'duration-trunc', 'epochs-avg', 'epochs-max', 'epochs-min', 'latency-95pctile-raw', 'latency-95pctile-raw-nowm', 'latency-95pctile-trunc', 'latency-95pctile-trunc-nowm', 'latency-avg-raw', 'latency-avg-raw-nowm', 'latency-avg-trunc', 'latency-avg-trunc-nowm', 'latency-stdev-raw', 'latency-stdev-raw-nowm', 'latency-stdev-trunc', 'latency-stdev-trunc-nowm', 'msg-batch-avg-trunc', 'nreq-raw', 'nreq-trunc', 'propose-rate-raw', 'propose-rate-trunc', 'throughput-raw', 'throughput-trunc', 'viewchanges-avg', 'viewchanges-total', 'latency-avg-shortened-raw', 'latency-95pctile-shortened-raw'}
