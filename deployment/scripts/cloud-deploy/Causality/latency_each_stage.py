...
if __name__=='__main__':
    sys.stdout = open('scripts/cloud-deploy/Causality/output.log','w')
    ...
    for name in experiment_names:
        ...
        for num in experiment_nums:
            ...
            for i in peer_dir:
                ...
                # print(i)
                lines = f.readlines()
                pattern_propose=r'Sending PREPREPARE.'
                pattern_commit=r'Committed entry.'
                ...
                for line in lines:
                    ...
                    if find_ is not None:
                        ...
                        sn_propose[int(line[find_sn.span()[0]+3:find_sn.span()[1]])]=cast_time(line)
